...
class OwnHomeDataMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeDataReference(16, 5) # selected brawler
        ...
        self.writeVInt(10)
        self.writeDataReference(15, 577) # map id
        self.writeVInt(-1)
        self.writeVInt(2)
        self.writeString("")
        self.writeVInt(0)
        ...
        unlocked_brawler = [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 95, 100, 105, 110, 115, 120, 125, 130, 177, 182, 188, 194, 200, 206, 218, 224, 230, 236, 279, 296, 303, 320, 327, 334, 341, 358, 365, 372, 379, 386, 393, 410, 417, 427, 434, 448, 466, 474, 491, 499, 507, 515, 523, 531, 539, 547, 557, 565, 573, 581, 589, 597, 605]
        ...
        for x in range(1):
            self.writeDataReference(23, 613)
            self.writeVInt(-1)
            self.writeVInt(1)
